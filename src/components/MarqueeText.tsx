...
const MarqueeText = () => {
  ...
  return (
    <div className="w-full overflow-hidden border-t border-b border-border py-4 bg-secondary">
      <div className="marquee-container">
        <div className="marquee-content animate-marquee">
          {Array(4).fill(marqueeText).map((text, idx) => (
            <span key={idx} className="text-xl md:text-2xl font-bold mx-4">{text}</span>
          ))}
        </div>
